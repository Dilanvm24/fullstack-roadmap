...
// create a function that returns an array of the books published in a given years range, the function should be named "getBooksForYearsRange", the function should receive 2 parameters (initial year and final year)

function getBooksForYearsRange(yearOne, yearTwo){
    let arrayVacio = [];
    for(let i = 0; i < bookCollection.length; i++){
        if((bookCollection[i].publicationYear >= yearOne) && (bookCollection[i].publicationYear <= yearTwo)){
...
console.log(getBooksForYearsRange(1953, 2000));