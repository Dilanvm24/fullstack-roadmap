...
// el siguiente console.log debe imprimir 3 parejas potenciales (Daniela de 29 años, Valentina de 30 años y Daniela de 58 años)
    ...
    function encontrarParejaPorInteres(personaBuscando){
        let personasPotenciales = [];
        for(let i = 0; i < personas.length; i++){
            if(personas[i].ciudad === personaBuscando.ciudad && personas[i].genero !== personaBuscando.genero){
                if(personas[i].intereses.includes("Arte", "Programacion", "Lectura", "Vaijes")){
                    personasPotenciales[personas[i]]
                }
