// create a function that returns an array of books based in the availability status, the function should be named "getBooksByAvailability", the function should receive only one boolean parameter that is the availability that we want to get (true to get all available books and false to get the unavailable books)
