...
//En base a mis conocimientos se recorre todo el string de la variable saludo, despues hacemos un condicional que evalua los espacio vacios de la variable saludo
// para que cada que el bucle for se itere se le agregue a los espacios en un guion bajo(_). si la condicion del if no se cumple, entonces entra en el else y el else lo que hace
// es devolver el saludo 
